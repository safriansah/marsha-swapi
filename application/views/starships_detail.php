            ...
            <div class="col-lg-12">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="<?php echo base_url() ?>starship"><?php echo $kode ?></a></li>
              ...
              <div id="productMain" class="row">
                <div class="col-md-6">
                  <div class="box">
                    ...
                    <h1 class="text-center"><img src="<?php echo base_url() ?>assets/img/starship.jpg" alt="" class="img-fluid"></h1>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="box">
                  ...
                  <p><b>crew : </b><?php echo $results["crew"] ?></p>
                  ...
                  <p><b>hyperdrive_rating : </b><?php echo $results["hyperdrive_rating"] ?></p>
                  <p><b>MGLT : </b><?php echo $results["MGLT"] ?></p>
                  <p><b>starships_class : </b><?php echo $results["starship_class"] ?></p>
                  </div>
                </div>
              </div>
